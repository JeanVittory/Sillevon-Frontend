...
import { IconMoodHappy, IconSend, IconKeyboard } from '@tabler/icons-react';
...
export default function ChatView({ currentChat, socket, userId }: ChatViewProps) {
			...
			<div className={styles.chatViewContent}>
				{messages.length > 0 &&
					messages.map((message) => {
						...
						return (
							<div key={message._id} className={!receiver ? styles.messageReciver : styles.messageSender}>
