...
const mockdata = [
	{
		...
		description: 'This is a powerful tool for make your bussiness more visited with live music.',
		icon: IconGauge,
	},
	{
	...
	return (
		<Container size='lg' py='xl'>
			...
			<Text color='dimmed' className={classes.description} align='center' mt='md'>
				To contact a musician or a band could be too dificult whether you do not have contacts, this web
				allows you to contract a musician without intermediaries.
			</Text>
