...
import { IconLock, IconCheck, IconBug, IconUser, IconChevronLeft } from '@tabler/icons';
...
export default function Settings({ user }: SettingsProps) {
	...
	const [avatar, setAvatar] = useState<string | ArrayBuffer | null>(user.imagesDone.avatar);
